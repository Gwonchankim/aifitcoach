...
| 5 | 프론트 핵심 플로우 (FEATURES_UX F0~F8) | 🟡 **진행 중** — 테스트 격리·요일 완료 · **M-UIa 71/100 조건부 통과**(F1 미결) | 69.5 → 70.0 · M-UIa **71** | 69.5 → 73.0 → **70.0** (아래 "STEP 5 현재 상태") |
| 6 | 오프라인 동기화 | ⬜ 예정 | |
...
| **F1** | **주 CTA 가 ink 가 아니라 파랑** | **미결 — 사람 결정 필요**(아래) |
...
F14 **한글 키커 대체 어법 미설계** — 프로토타입의 지배적 모티프(139회)를 구현은 3곳만 쓴다. UIb 착수 전 design+오너.
