...
| 5 | 프론트 핵심 플로우 (FEATURES_UX F0~F8) | 🟡 **진행 중** — 실기기 확인 완료(08-08) · 테스트 격리·요일 완료(08-09) · **M-UIa 착수 대기** | 69.5 → 73.0 → **70.0** (아래 "STEP 5 현재 상태") |
| 6 | 오프라인 동기화 | ⬜ 예정 | |
...
### ▶ 다음 마일스톤 — M-UIa 착수 계획 (2026-08-09 수립, **승인 대기 · 코드 없음**)
