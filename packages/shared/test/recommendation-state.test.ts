...
describe("ADR-70 recommendation state OR normalization", () => {
  ...
  it.each([
    [{ state: "ready", reason: null, weight: null, load_kind: "bodyweight" }, "ready"],
    [{ state: null, reason: null, weight: 50, load_kind: "external" }, "ready"],
    [
      { state: "substitution_required", reason: null, weight: null, load_kind: "external" },
      "substitution_required",
    ],
    [
      { state: "load_calibration_needed", reason: null, weight: null, load_kind: "external" },
