...
export function DaysStep({ draft, onChange }: StepProps) {
  return (
    <div className="flex flex-col gap-3">
      ...
      <p className="text-sm text-fg-muted">회복일을 사이에 두고 요일을 배치해 드려요.</p>
    </div>
  );
}
...
export function MinutesStep({ draft, onChange }: StepProps) {
  return (
    <div className="flex flex-col gap-3">
      ...
      <p className="text-sm text-fg-muted">세트 사이 휴식까지 포함한 시간이에요.</p>
    </div>
  );
}
...
export function ExperienceStep({ draft, onChange }: StepProps) {
  return (
    <div className="flex flex-col gap-3">
      ...
      <p className="text-sm text-fg-muted">경력에 맞는 난도의 종목을 골라 드려요.</p>
    </div>
  );
}
...
export function EquipmentStep({ draft, onChange }: StepProps) {
  return (
    <div className="flex flex-col gap-3">
      <p className="text-sm text-fg-muted">여러 개 고를 수 있어요. 고른 장비로만 계획을 짜요.</p>
