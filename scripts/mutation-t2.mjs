...
const MUTATIONS = [
  ...
  },
  {
    ...
    to: '  typeof value === "number" && Number.isSafeInteger(value) && value >= 0 && value <= 600;',
  },
  {
    id: 5,
    file: STORE,
  ...
  },
  {
    ...
    file: STORE,
    what: "clear 를 큐 밖으로",
    from: "  await enqueue(restTimerKeyFor(sessionId), () => rawDelete(userId, sessionId));",
  ...
  /* ---- 세트 정체성 ---- */
  {
    ...
    from: "    if (record !== null && record.planned_set_id !== plannedSetId) return;",
    to: "    if (false) return;",
  },
  {
    id: 18,
